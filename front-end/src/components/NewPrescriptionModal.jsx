                  ...
                  {patientData ? (
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200 ${
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition duration-200 flex items-center"
                >
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <div className="flex items-center">
                          ...
                          {medication.strength && (
                            <div className="ml-2">
                              <div className="px-3 py-2 bg-emerald-100 text-emerald-800 rounded-lg font-medium">
                                {medication.strength}
                              </div>
                            </div>
                          )}
                      ...
                      <div>
                        ...
                        <div className="flex">
                          <input
                            ...
                            step="0.1"
                            className={`flex-1 px-4 py-3 border rounded-l-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200 ${
                          ...
                          <select
                            ...
                            className="px-4 py-3 border border-l-0 border-gray-300 rounded-r-lg bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200"
                          >
                            {doseUnits.map(unit => (
                      ...
                      <div>
                        ...
                        <div className="flex">
                          <input
                            ...
                            onBlur={() => calculateQuantity(index)}
                            className="flex-1 px-4 py-3 border rounded-l-lg border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200"
                            placeholder="7"
                          />
                          <select
            ...
            <div className="flex justify-between pt-6 border-t border-gray-200">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="px-5 py-2.5 border border-emerald-300 text-emerald-700 rounded-lg font-medium hover:bg-emerald-50 transition duration-200"
                >
                  Preview
                </button>
