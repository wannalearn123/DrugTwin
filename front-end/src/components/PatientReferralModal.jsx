...
const PatientReferralModal = ({ 
  ...
  const priorityOptions = [
    ...
    { value: 'routine', label: 'Rutin (1-2 minggu)', color: 'bg-emerald-100 text-emerald-800' },
    { value: 'elective', label: 'Elektif (>2 minggu)', color: 'bg-emerald-100 text-emerald-800' }
  ];
            ...
            <div className="flex justify-between mt-8 pt-6 border-t border-gray-200">
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="px-4 py-2.5 border border-emerald-300 text-emerald-700 rounded-lg font-medium hover:bg-emerald-50 transition duration-200 flex items-center"
                >
