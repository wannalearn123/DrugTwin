              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        <Droplets size={16} className="mr-2 text-emerald-500" />
                        Glukosa Darah
                      </label>
                      <input
                        type="number"
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {formData.vitalSigns.bmi && (
                            <div className={`px-3 py-1 rounded-full text-sm font-medium ${
                              ...
                              parseFloat(formData.vitalSigns.bmi) < 25 ? 'bg-emerald-100 text-emerald-800' :
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-emerald-500 transition duration-200">
                      {formData.photo ? (
                        ...
                        <>
                          ...
                          <label className="inline-block px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 cursor-pointer transition duration-200">
              ...
              <div className="flex space-x-3">
                ...
                {currentStep < 4 ? (
                  <button
                    ...
                    className="px-5 py-2.5 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition duration-200"
                  >
                    Lanjut
                  </button>
                ) : (
