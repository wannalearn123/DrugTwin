    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="space-y-6 text-gray-700">
            <p className="leading-relaxed">
              ...
              and the owners and operators ("we", "us", or "<span className="font-semibold text-emerald-600">Drug Twin</span>") 
        ...
        <div className="flex justify-end space-x-4 p-6 border-t border-gray-200 bg-gray-50">
          ...
          <button
            onClick={onAccept}
            className="px-6 py-3 bg-emerald-600 text-white rounded-lg font-semibold hover:bg-emerald-700 transition duration-200"
          >
            ACCEPT
          </button>
        </div>
