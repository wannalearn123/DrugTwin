          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200 pr-12 ${
            ...
            <div className="flex items-start space-x-3 bg-gray-50 p-4 rounded-lg">
              <input 
                ...
                onChange={handleChange}
                className={`w-5 h-5 mt-0.5 text-emerald-600 border rounded focus:ring-emerald-500 focus:ring-2 ${
              ...
              <label htmlFor="terms" className="text-sm text-gray-700 flex-1">
                ...
                <button
                  ...
                  className="text-emerald-600 font-semibold hover:text-emerald-700 underline transition duration-200"
                >
                  Terms & Conditions
                </button>
            ...
            <button 
              ...
              className={`w-full py-4 rounded-lg font-semibold transition duration-300 shadow-sm ${
                isFormValid && !isSubmitting
                  ? 'bg-emerald-600 text-white hover:bg-emerald-700 transform hover:scale-[1.02]'
