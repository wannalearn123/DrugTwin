...
import { Stethoscope, Pill, User2, PillBottle, ArrowRight, LogIn, Shield } from 'lucide-react';
        ...
        <div className="max-w-md w-full">
          ...
          <div className="space-y-4 mb-8">
            ...
            <button
              ...
              className="w-full p-6 rounded-xl border-2 border-emerald-200 bg-white hover:border-emerald-400 hover:bg-emerald-50 transition-all duration-200 text-left group"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="bg-emerald-100 text-emerald-600 w-14 h-14 rounded-full flex items-center justify-center group-hover:bg-emerald-200 transition duration-200">
                    <User2 size={28} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-emerald-700 text-lg">Pasien</h3>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-emerald-700 text-lg">Dokter</h3>
                    <p className="text-sm text-gray-600">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-emerald-700 text-lg">Apoteker</h3>
                    <p className="text-sm text-gray-600">
          ...
          <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            <button
              ...
              className="w-full p-3 rounded-lg border border-emerald-300 bg-white hover:bg-emerald-50 transition-all duration-200 text-left group"
            >
              <div className="flex items-center justify-between">
          ...
          <div className="space-y-4">
            ...
            <Link
              to="/create-account"
              className="w-full flex items-center justify-center gap-3 py-4 border-2 border-emerald-600 text-emerald-600 rounded-xl font-semibold hover:bg-emerald-600 hover:text-white transition-all duration-200 group"
            >
              <LogIn size={20} />
              Create New Account
