...
import { X, Eye, EyeOff, Mail, Lock, Stethoscope, User2, Pill } from 'lucide-react';
...
const LoginModal = ({ 
  ...
  const roleConfig = {
    dokter: { 
      title: 'Dokter', 
      icon: Stethoscope, 
      color: 'green', // DOKTER -> HIJAU (sebelumnya biru)
    ...
    pasien: { 
      title: 'Pasien', 
      icon: User2, 
      color: 'purple', // PASIEN -> UNGU (tetap)
    ...
    apoteker: { 
      title: 'Apoteker', 
      icon: Pill, 
      color: 'blue', // APOTEKER -> BIRU (sebelumnya hijau)
  ...
  const getButtonColorClass = () => {
    ...
    return colorMap[config.color] || colorMap.green;
  };
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  onChange={handleChange}
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200"
