    ...
    <div className={`bg-white rounded-xl shadow-lg border border-gray-200 ${!compact && 'p-6'}`}>
        ...
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {patient.vitalSigns?.glucose && (
              <div className="flex items-center">
                <Droplets size={20} className="mr-3 text-blue-500" />
                <div>
      ...
      <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
        {onFollowUp && (
          <button
            onClick={onFollowUp}
            className="px-5 py-2.5 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition duration-200 flex items-center"
          >
        ...
        {onMessage && (
          <button
            onClick={onMessage}
            className="px-5 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition duration-200 flex items-center"
          >
